...
src/
  core/            # shared between BOTH variants — must build to byte-identical output
    ...
    dashboard.js         withEventDefaults, event CRUD, renderDashboard, per-event Overview tab (widget catalog, compute + render functions, visibility/order controls, beamer/sound-hook bar)
