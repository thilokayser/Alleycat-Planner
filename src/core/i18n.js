...
const translations = {
  de: {
    ...
    exportPdf: {
      ...
      cpQrManualCode: 'Fällt die Kamera aus: Code {code}',
    ...
    featureRegistry: {
      ...
      riderAppUrlSaved: 'Fahrer-App-Adresse gespeichert',
      riderAppUrlSaveFailed: 'Fahrer-App-Adresse konnte nicht gespeichert werden',
      groupUsersHeading: 'Funktionsumfang',
      groupUsersDesc: 'Zusatzfunktionen der Benutzerverwaltung und der Einladungscodes ein- und ausblenden. Gilt nur für diesen Browser.',
      ...
      inviteDefaultExpiryName: 'Einladungscode-Standardablauf',
      inviteDefaultExpiryDesc: 'Schlägt beim Erstellen von Einladungscodes automatisch „in 7 Tagen" als Ablaufdatum vor, statt das Feld leer zu lassen.',
      inviteRegistrationValidityName: 'Restgültigkeit im Registrierungs-Screen',
      inviteRegistrationValidityDesc: 'Zeigt auf dem Registrierungs-Screen an, bis wann der verwendete Einladungscode gültig ist (reine Anzeige, ohne Einfluss auf die Prüfung selbst).',
      userPasswordResetName: 'Passwort-Reset-Codes',
      userPasswordResetDesc: 'Erlaubt, für einen Benutzer einen einmaligen Reset-Code zu erzeugen, mit dem er sich ohne E-Mail ein neues Passwort setzen kann.',
      userLogoutAllName: 'Überall abmelden',
      userLogoutAllDesc: 'Zeigt pro Benutzer einen Knopf, der alle seine aktiven Sitzungen auf einen Schlag beendet.',
      userListToolsName: 'Benutzerliste: Suche & Filter',
      userListToolsDesc: 'Suchfeld sowie Filter/Sortierung nach Rolle und zuletzt aktiv in der Benutzerverwaltung.',
      userBulkActionsName: 'Benutzerliste: Bulk-Aktionen',
      userBulkActionsDesc: 'Mehrere Benutzer gleichzeitig auswählen und Rolle ändern oder sperren/entsperren.',
      userCsvExportName: 'Benutzerliste: CSV-Export',
      userCsvExportDesc: 'Exportiert die aktuell gefilterte Benutzerliste als CSV-Datei.',
      userAuditLogName: 'Audit-Log',
      userAuditLogDesc: 'Zeigt eine installationsweite Liste von Login-, Rollen- und Passwort-Änderungen unter Benutzerverwaltung.'
    },
    socialShare: {
    ...
    riderScan: {
      ...
      cpCodeButton: 'Code stattdessen eintippen',
      cpCodeTitle: 'Checkpoint-Code eingeben',
      cpCodeLead: 'Checkpoint-ID und Code stehen auf dem Aufsteller am Checkpoint, unter dem QR-Code.',
      cpCodeCpIdLabel: 'Checkpoint-ID',
      cpCodeTokenLabel: 'Code',
      cpCodeSubmit: 'Einchecken',
      cpCodeCancel: 'Zurück',
      ...
      /* Fahrer-Konten (Spokecard-Claiming) — Login/Register/Reset/Profil,
         unabhängig von der Slot-Session oben. */
      ...
      acctForgotSent: 'Falls ein Konto mit dieser E-Mail existiert, wurde eine Mail verschickt.',
      acctResetTitle: 'Neues Passwort setzen',
      acctResetPasswordLabel: 'Neues Passwort',
      acctResetSubmit: 'Passwort setzen',
      acctResetDone: 'Passwort geändert — jetzt anmelden.',
      acctLogout: 'Abmelden',
      claimButton: 'Diese Startnummer meinem Konto zuordnen',
      claimButtonLoggedOut: 'Startnummer zu meinem Konto hinzufügen',
      claimDone: 'Startnummer deinem Konto zugeordnet.',
      profileLink: 'Mein Konto',
      profileTitle: 'Hallo, {name}',
      profileEmpty: 'Noch keine Rennen mit diesem Konto verbunden.',
      ...
      errAcctEmailTaken: 'Diese E-Mail-Adresse ist schon registriert.',
      errAcctRegisterFailed: 'Konto konnte nicht angelegt werden.',
      errAcctResetFailed: 'Link ungültig oder abgelaufen.',
      errClaimNoSlot: 'Du hast gerade keine aktive Startnummer, die du zuordnen könntest.',
      errClaimFailed: 'Startnummer konnte nicht zugeordnet werden.'
    },
    ...
    phpSetup: {
      ...
      apiKeyOptionalHint: 'Normalerweise leer lassen — melde dich mit dem Konto an, das die Installation angelegt hat. Den Master-Key brauchst du nur für Wartungszugriff oder für eine Altinstallation ohne Benutzerkonto.',
      ...
      installHint: 'Endpunkt und Key erhältst du nach dem Ausführen von {installPhp} im {phpBackend}-Ordner. Liegt die App auf derselben Domain wie das Backend, findet sie den Endpunkt selbst — dieser Bildschirm erscheint dann nur noch über {resetParam} an der URL.',
    ...
    auth: {
      ...
      registerValidUntil: 'Code gültig bis {date}.',
      resetLoginLink: 'Ich habe einen Passwort-Reset-Code',
      resetTitle: 'Passwort zurücksetzen',
      resetDesc: 'Mit einem vom Admin erzeugten Reset-Code ein neues Passwort setzen.',
      resetCodeLabel: 'Reset-Code',
      resetPasswordLabel: 'Neues Passwort',
      resetButton: 'Passwort setzen',
      resetErrorInvalid: 'Code ungültig oder abgelaufen.',
      resetSuccessMessage: 'Passwort geändert — jetzt anmelden.',
      resetCodeCreateButton: 'Reset-Code erzeugen',
      resetCodeErrorGeneric: 'Reset-Code konnte nicht erstellt werden.',
      resetCodeJustCreatedHint: 'Wird nicht wieder angezeigt — jetzt kopieren und weitergeben:',
      usersLogoutAllButton: 'Überall abmelden',
      usersLogoutAllConfirm: 'Alle aktiven Sitzungen von „{username}“ wirklich beenden?',
      usersLogoutAllDoneToast: 'Alle Sitzungen beendet.',
      usersSearchPlaceholder: 'Benutzer suchen…',
      usersFilterAllRoles: 'Alle Rollen',
      usersSortUsername: 'Nach Benutzername',
      usersSortRole: 'Nach Rolle',
      usersSortLastSeen: 'Nach zuletzt aktiv',
      usersBulkSelectedCount: '{count} ausgewählt',
      usersBulkApplyRole: 'Rolle setzen',
